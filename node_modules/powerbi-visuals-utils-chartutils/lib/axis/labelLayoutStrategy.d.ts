 ...
 */
export declare function rotate(labelSelection: d3.Selection<any, any, any, any>, maxBottomMargin: number, textTruncator: (properties: TextProperties, maxWidth: number) => string, textProperties: TextProperties, needRotate: boolean, needEllipsis: boolean, axisProperties: IAxisProperties, margin: IMargin, scrollbarVisible: boolean): void;
export declare function wordBreak(text: d3.Selection<any, any, any, any>, axisProperties: IAxisProperties, maxHeight: number): void;
export declare function clip(text: d3.Selection<any, any, any, any>, availableWidth: number, svgEllipsis: (textElement: SVGTextElement, maxWidth: number) => void): void;
