# How to contribute
If you would like to contribute to the Power BI visuals TestUtils there are many ways you can help.

## Reporting issues
We use [GitHub issues](https://github.com/Microsoft/powerbi-visuals-utils-testutils/issues) as an issue tracker for the repository. Firstly, please search in open issues and try to make sure your problem doesn't exist. If there is an issue, add your comments to this issue.
...
1. Fork [the repository](https://github.com/Microsoft/powerbi-visuals-utils-testutils)
