...
export declare class TemporalType implements TemporalTypeDescriptor {
    ...
    get month(): boolean;
    get day(): boolean;
    get paddedDateTableDate(): boolean;
}
export declare class GeographyType implements GeographyTypeDescriptor {
    ...
    get address(): boolean;
    get city(): boolean;
    get continent(): boolean;
    get country(): boolean;
    get county(): boolean;
    get region(): boolean;
    get postalCode(): boolean;
    get stateOrProvince(): boolean;
    get place(): boolean;
...
export declare class FormattingType implements FormattingTypeDescriptor {
    ...
    constructor(underlyingType: ExtendedType);
    get color(): boolean;
    get formatString(): boolean;
    get alignment(): boolean;
    get labelDisplayUnits(): boolean;
    get fontSize(): boolean;
    get labelDensity(): boolean;
}
